...
- (void) animate:(NSNumber *)num {
    ...
    // Resize the image.
    float optimusWidth  = (image.size.width * resizeRatio) * kEnlargementRatio;
    float optimusHeight = (image.size.height * resizeRatio) * kEnlargementRatio;
